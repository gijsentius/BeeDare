...
\begin{document}
% \lstset{language=Java} % set your global programming language here or define locally (see examples)   
%----------------------------------------------------------------------------------------
%	TITLE PAGE
%----------------------------------------------------------------------------------------
...
% \lstinputlisting{source_filename.py} % input a file
\begin{mdframed}[style=code_box]
\lstinputlisting[language=Python, caption=python snippet]{/home/entix/Documents/project_2_4/documentatie_project_24/code_snippets/example.py} % local language identifier
\end{mdframed}

\lstset{language=Java} % change programming language
