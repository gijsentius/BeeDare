...
% \usepackage{inputenc} % to type accents and other special characters

\usepackage{tabto} % package to use \tab to place tabs

\usepackage{svg} % package to include svg files

\usepackage{pdfpages} % to add pdf files to a document
...
\mdfdefinestyle{code_box}{backgroundcolor=light-gray, 
...
% \newmdenv[backgroundcolor=light-gray, 
% roundcorner=10pt,leftmargin=1, 
% rightmargin=1, 
% innerleftmargin=15, 
% innertopmargin=15,
