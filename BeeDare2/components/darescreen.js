...
class DareScreen extends Component {
    ...
    //Challenge.body does not work yet because challenges return empty at 
    makeCards(){
        let cards = [];
        let i = 0;
        for(let challenge in this.state.challenges){
            ...
            let card = {
                ...
                //Title Should at least be 7 or 8 characters long! Otherwise it scales badly
                picture: require('../images/logo2.png'),
                content: <Text>{challenge.body}</Text>,
            };
            i++;
            cards.push(card);
        }
